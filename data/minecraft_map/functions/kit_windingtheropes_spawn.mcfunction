...
give @a[tag=kit_windingtheropes] netherite_sword{Unbreakable:1,Damage:0,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:6,Operation:0,UUID:[I;-12129,15231,175051,-30462],Slot:mainhand,Name:"generic.attack_damage"}]} 1